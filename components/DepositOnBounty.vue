<template>
  <div class="modal fade" id="deposit-bounty-modal" tabindex="-1" role="dialog">
    <div class="modal-dialog text-dark text-left" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <small>
            Please take PayPal's fees of 4.4% plus 0.30 USD into account. We are
            already working on a solution with smaller fees.
          </small>
